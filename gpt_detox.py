...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(default="EleutherAI/pythia-160m-deduped", metadata={"help": "the model name"})
    ...
    model_save_path: Optional[str] = field(
        default="./pythia-160m-detoxified-long-context-26-shl-1e4-final",
